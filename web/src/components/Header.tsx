            ...
            <Dialog.Root>
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content
                        ...
                        <Dialog.Close
                            className='absolute rounded-lg right-6 top-6 text-zinc-200 hover:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-zinc-900'>
